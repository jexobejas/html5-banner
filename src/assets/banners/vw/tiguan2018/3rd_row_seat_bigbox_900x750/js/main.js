...
function Animation(car) {
	...
	function run() {
		Velocity.RunSequence([
	        ...
	        { e: document.getElementById('seat-2-1'), p: { translateX: '+=50', width: '408px', opacity: 1 }, o: { duration: 500 } },
	        { e: document.getElementById('seat-2-2'), p: { translateX: '+=100', width: '380px', opacity: 1 }, o: { duration: 500, sequenceQueue: false } },
	        { e: document.getElementById('seat-3-1'), p: { translateX: '-=50', width: '408px', opacity: 1 }, o: { duration: 500, sequenceQueue: false } },
	        { e: document.getElementById('seat-3-2'), p: { translateX: '-=100', width: '380px', opacity: 1 }, o: { duration: 500, sequenceQueue: false } },
	        { e: document.getElementById('super-2'), p: { translateX: '-=900' }, o: { delay: 700, duration: 300 } },
	        { e: document.getElementById('seats'), p: { translateX: '-=900' }, o: { duration: 1000, sequenceQueue: false } },
