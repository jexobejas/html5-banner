...
function Animation(car) {
	...
	function run() {
		Velocity.RunSequence([
	        ...
	        { e: document.getElementById('super-1'), p: { translateX: '-=600' }, o: { delay: 900, duration: 600 } },
	        ...
	        { e: document.getElementById('super-2'), p: { translateX: '-=600' }, o: { delay: 700, duration: 600 } },
	        ...
	        { e: document.getElementById('super-3'), p: { translateX: '-=600' }, o: { delay: 1200, duration: 600 } },
	        { e: document.getElementById('super-4'), p: { translateX: '-=300' }, o: { duration: 600, easing: "easeOutSine" } },
	        { e: document.getElementById('super-4'), p: { translateX: '-=600' }, o: { delay: 1200, duration: 600 } },
	        { e: document.getElementById('car'), p: { alpha: 0,
			translateY: '+=12',
			translateX: '+=35',
			scaleY: 8,scaleX: 8,
			transformOrigin: "right center", opacity: 1 }, o: { duration: 800, easing: "easeOutBack" } },
