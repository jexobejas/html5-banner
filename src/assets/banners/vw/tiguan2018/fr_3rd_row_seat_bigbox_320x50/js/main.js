...
function Animation(car) {
	...
	function run() {
		Velocity.RunSequence([
	        ...
	        { e: document.getElementById('seat-2-1'), p: { translateX: '+=17', width: '55px', opacity: 1 }, o: { duration: 500 } },
	        { e: document.getElementById('seat-2-2'), p: { translateX: '+=31', width: '50px', opacity: 1 }, o: { duration: 500, sequenceQueue: false } },
	        { e: document.getElementById('seat-3-1'), p: { translateX: '-=11', width: '55px', opacity: 1 }, o: { duration: 500, sequenceQueue: false } },
	        { e: document.getElementById('seat-3-2'), p: { translateX: '-=21', width: '50px', opacity: 1 }, o: { duration: 500, sequenceQueue: false } },
