...
function Animation(car) {
	...
	function run() {
		Velocity.RunSequence([
	        ...
	        { e: document.getElementById('suitcase-2-1'), p: { translateX: '+=45',translateY: '-=7', width: '155px', opacity: 1 }, o: { duration: 500 } },
	        { e: document.getElementById('suitcase-2-2'), p: { translateX: '+=90',translateY: '-=13', width: '145px', opacity: 1 }, o: { duration: 500, sequenceQueue: false } },
	        { e: document.getElementById('suitcase-3-1'), p: { translateX: '-=45',translateY: '-=7', width: '155px', opacity: 1 }, o: { duration: 500, sequenceQueue: false } },
	        { e: document.getElementById('suitcase-3-2'), p: { translateX: '-=90',translateY: '-=13', width: '145px', opacity: 1 }, o: { duration: 500, sequenceQueue: false } },
