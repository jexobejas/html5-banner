...
function Animation(car) {
	...
	function run() {
		Velocity.RunSequence([
	        ...
	        { e: document.getElementById('suitcase-2-1'), p: { translateX: '+=15', width: '50px', opacity: 1 }, o: { duration: 500 } },
	        { e: document.getElementById('suitcase-2-2'), p: { translateX: '+=29', width: '45px', opacity: 1 }, o: { duration: 500, sequenceQueue: false } },
	        { e: document.getElementById('suitcase-3-1'), p: { translateX: '-=13', width: '50px', opacity: 1 }, o: { duration: 500, sequenceQueue: false } },
	        { e: document.getElementById('suitcase-3-2'), p: { translateX: '-=23', width: '45px', opacity: 1 }, o: { duration: 500, sequenceQueue: false } },
