...
<?php
	...
	$arr_uTitle[] = "300x250 - Seats";
	$arr_uSource[] = "3<sup>rd</sup>_row_seat_bigbox_300x250/index.html";
	$arr_uType[] = "page";
	$arr_uWidth[] = "300";
	$arr_uHeight[] = "250";
	$arr_uClick[] = "";

	$arr_uTitle[] = "320x50 - Seats";
	$arr_uSource[] = "3<sup>rd</sup>_row_seat_bigbox_320x50/index.html";
	$arr_uType[] = "page";
	$arr_uWidth[] = "320";
	$arr_uHeight[] = "50";
	$arr_uClick[] = "";

	$arr_uTitle[] = "300x600 - Seats";
	$arr_uSource[] = "3<sup>rd</sup>_row_seat_bigbox_300x600/index.html";
	$arr_uType[] = "page";
	$arr_uWidth[] = "300";
	$arr_uHeight[] = "600";
	$arr_uClick[] = "";

	$arr_uTitle[] = "728x90 - Seats";
	$arr_uSource[] = "3<sup>rd</sup>_row_seat_bigbox_728x90/index.html";
	$arr_uType[] = "page";
	$arr_uWidth[] = "728";
	$arr_uHeight[] = "90";
	$arr_uClick[] = "";

	$arr_uTitle[] = "300x250 - Cargo";
	$arr_uSource[] = "cargo_space_bigbox_300x250/index.html";
	$arr_uType[] = "page";
	$arr_uWidth[] = "300";
	$arr_uHeight[] = "250";
	$arr_uClick[] = "";

	$arr_uTitle[] = "320x50 - Cargo";
	$arr_uSource[] = "cargo_space_bigbox_320x50/index.html";
	$arr_uType[] = "page";
	$arr_uWidth[] = "320";
	$arr_uHeight[] = "50";
	$arr_uClick[] = "";

	$arr_uTitle[] = "300x600 - Cargo";
	$arr_uSource[] = "cargo_space_bigbox_300x600/index.html";
	$arr_uType[] = "page";
	$arr_uWidth[] = "300";
	$arr_uHeight[] = "600";
	$arr_uClick[] = "";

	$arr_uTitle[] = "728x90 - Cargo";
	$arr_uSource[] = "cargo_space_bigbox_728x90/index.html";
	$arr_uType[] = "page";
	$arr_uWidth[] = "728";
	$arr_uHeight[] = "90";
	$arr_uClick[] = "";
...
<head>
  ...
  <meta charset="utf-8">
  <title><?php echo $clientName . " - " . $projectName ?></title>
	<meta name="viewport" content="width=768, initial-scale=1.0">
  <meta name="description" content="Client preview for <?php echo $clientName . " - " . $projectName ?>">
  ...
  <div class="container-fluid" style="padding-bottom:10px; margin-bottom:10px;">
  	<div class="row-fluid">
        <div class="page-header pull-left" style="border-bottom:0px solid #fff;">
          <h1><?php echo $clientName . " - " . $projectName ?></h1>
          <br>
		    <div class="row">
		      <div class="span-nav">
